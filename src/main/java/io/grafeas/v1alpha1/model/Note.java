...
import io.grafeas.v1alpha1.model.Basis;
import io.grafeas.v1alpha1.model.BuildType;
import io.grafeas.v1alpha1.model.Deployable;
import io.grafeas.v1alpha1.model.Discovery;
import io.grafeas.v1alpha1.model.ModelPackage;
import io.grafeas.v1alpha1.model.RelatedUrl;
import io.grafeas.v1alpha1.model.VulnerabilityType;
...
public class Note   {
  ...
  @SerializedName("attestationAuthority")
  ...
  **/
  @ApiModelProperty(example = "null", value = "A note describing an attestation role.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, note.name) &&
        ...
        Objects.equals(this.attestationAuthority, note.attestationAuthority) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, shortDescription, longDescription, kind, vulnerabilityType, buildType, baseImage, _package, deployable, discovery, attestationAuthority, relatedUrl, expirationTime, createTime, updateTime, operationName, relatedNoteNames);
  }
