...
public class ImageFingerprint {
   ...
   * @return v1Name
  **/
  @ApiModelProperty(value = "Required. The layer ID of the final layer in the Docker image's v1 representation.")
   ...
   * @return v2Blob
  **/
  @ApiModelProperty(value = "Required. The ordered list of v2 blobs that represent a given image.")
   ...
   * @return v2Name
  **/
  @ApiModelProperty(value = "Output only. The name of the image's v2 blobs computed via:   [bottom] := v2_blob[bottom]   [N] := sha256(v2_blob[N] + \" \" + v2_name[N+1]) Only the name of the final blob is kept.")
